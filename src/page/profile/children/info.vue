 <template>
    <div class="rating_page">
        ...
        <section class="profile-info">
            ...
            <section class="bind-phone" id="zhbd">
                账号绑定
            </section>
        ...
        methods: {
            ...
            async uploadAvatar(){
                ...
                if (this.userInfo) {
                    ...
                    // async 函数 try catch 错误处理 异常捕获  抛出异常  error
                    try{
                        /**
                        ...
                        */
                        let response = await fetch('/eus/v1/users/' + this.userInfo.user_id + '/avatar', {
                              method: 'POST',
                              credentials: 'include',
                              body: data  // 请求发送的数据 blob、BufferSource、FormData、URLSearchParams（get或head方法中不能包含body）
                            })
        ...
        watch: {
            userInfo: function (value) {
                if (value && value.user_id) {
                   ...
                   /* {
                        "username": "13256233214",
                        "user_id": 23772,
                        "id": 23772,
                        "city": "上海",
                        "registe_time": "2019-03-14 16:49",
                        "column_desc": {
