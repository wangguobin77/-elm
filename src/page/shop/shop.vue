 <template>
    <div>
        <section v-if="!showLoading" class="shop_container">
            ...
            <!-- 选择类型商品时  v-show 来判断要显示的区域-->
            <!--transion  过度动画 animation-name:fade-choose-->
            <transition name="fade-choose">
                <section v-show="changeShowType =='food'" class="food_container">
                    <section class="menu_container">
                        <!-- 上面切换的tab栏 商家 评分之间的切换 -->
                                    ...
                                    <section v-for="(foods,foodindex) in item.foods" :key="foodindex" class="menu_detail_list">
                                        <router-link  :to="{path: 'shop/foodDetail', query:{image_path:foods.image_path, description: foods.description, month_sales: foods.month_sales, name: foods.name, rating: foods.rating, rating_count: foods.rating_count, satisfy_rate: foods.satisfy_rate, foods, shopId}}" tag="div" class="menu_detail_link">
                                            ...
                                            <section class="menu_food_description">
                                                <h3 class="food_description_head">
                                                    ...
                                                    <!--根据 v-if='attributes.length' 长度来控制显示隐藏-->
                                                ...
                                                <p v-if="foods.activity" class="food_activity">x
                                        ...
                                        <footer class="menu_detail_footer">
                                            <section class="food_price">
                                                ...
                                                <span v-if="!foods.specifications.length">起</span>  <!--foods.specifications.length==0显示-->
                                            </section>

                                            <!--添加购物车按键  buyCart组件 -->
                                            <buyCart :shopId='shopId' :foods='foods'
                                                @moveInCart="listenInCart" @showChooseList="showChooseList"
                                                @showReduceTip="showReduceTip" @showMoveDot="showMoveDotFun">
                                            </buyCart>
                                        </footer>
                        ...
                        <section>
                            ...
                            <header class="rating_header">
                                ...
                                <section class="rating_header_right">
                                    ...
                                    <p>
                                        <span>送达时间</span>
                                        <span class="delivery_time">{{shopDetailData.order_lead_time==''? 10 :shopDetailData.order_lead_time}}分钟</span>
                                    </p>
                                </section>
                            </header>
...
<script>
    ...
    export default {
        ...
        mounted(){//钩子函数 执行了钩子函数后才完成对initData()的调用
            this.initData();
        ...
        methods: {
            ...
            async initData(){
                 ...
                 * 具体的商铺信息
                 */
                // console.log(JSON.stringify(this.shopDetailData));
            ...
            showTitleDetail(index){
                console.log(index+'--'+this.TitleDetailIndex);
            ...
            // reduce_cart  移出购物车，所需7个参数，商铺id，食品分类id，食品id，食品规格id，食品名字，食品价格，食品规格
            ...
            //监听圆点是否进入购物车 判断加入购物车的圆点是否落到相应的位置
            listenInCart(){
            ...
            showChooseList(foods){
                ...
                this.specsIndex = 0; //规格参数下标
            },
            // 记录当前所选规格的索引值
            chooseSpecs(index){
                this.specsIndex = index; //赋值当前所选 spec的小标
            },
            //多规格商品加入购物车
            ...
            showReduceTip(){
                ...
                this.timer = setTimeout(() => {
                    clearTimeout(this.timer);
                    this.showDeleteTip = false;//删除提示不显示
                }, 3000);
            },
            //显示下落圆球
            //从子组件中接收数据  elLeft elBottom showMoveDot
            ...
            beforeEnter(el){
                el.style.transform = ` (0,${37 + this.elBottom - this.windowHeight}px,0)`;
